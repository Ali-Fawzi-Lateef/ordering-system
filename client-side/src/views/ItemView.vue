  ...
  <div v-else class="card static w-11/12 sm:w-[36rem] mx-auto m-4 bg-base-100 shadow-xl">
    ...
    <form class="card-body items-center text-center">
      ...
      <div class="form-control">
        ...
        <input type="text" title="price" placeholder="price" class="input w-[20rem] input-bordered" v-model="price" />
      </div>
      <div class="form-control">
        <label class="label">
          <span class="label-text">Item Quantity</span>
        </label>
        <input type="text" title="quantity" placeholder="quantity" class="input w-[20rem] input-bordered" v-model="quantity" />
      </div>
